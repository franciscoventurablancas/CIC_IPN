#!/usr/bin/env python3
"""
Para este ejercicio estoy utilizando como referencia la implementacion del 
autor descrito abajo y la mando a llamar en Google Colab, se reviso la
implementacion previa para para este cifrado de flujo
